...
unsigned char lxl[4]= {0x92,0xcd,0x8b,0x23};    //41623178
unsigned char card_1[4]= {0x1c,0xc8,0xd8,0x73}; //41623000
unsigned char card_2[4]= {0xA4,0xF9,0xDF,0x1E}; //41623999
unsigned char card_3[4]= {0x92,0xfd,0x77,0x23}; //41623172
unsigned char card_4[4]= {0xe2,0xfc,0x9f,0x42}; //41623173
...
void SPI1_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(	RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOE, ENABLE );//PORTA、B时钟使能
